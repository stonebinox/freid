                    ...
                    <div class="card-deck">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <ul class="author-2">
                                    <li>
                                        <a href="#"><img class="" src="img/users/12.jpg" alt="..." /> &nbsp; <span> Sean</span></a>
                                    </li>
                                </ul>
                                <!-- /.bottom_data -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <ul class="author-2">
                                    <li>
                                        <a href="#"><img class="" src="img/users/11.jpg" alt="..." /> &nbsp; <span> Amanda</span></a>
                                    </li>
                                </ul>
                                <!-- /.bottom_data -->
                                <ul class="bottom_data pull-right hidden-xs-down">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <ul class="author-2">
                                    <li>
                                        <a href="#"><img class="" src="img/users/10.jpg" alt="..." /> &nbsp; <span>Charles</span> </a>
                                    </li>
                                </ul>
                                <!-- /.bottom_data -->
                                <ul class="bottom_data pull-right hidden-xs-down">
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <ul class="author-2">
                                    <li>
                                        <a href="#"><img class="" src="img/users/1.jpg" alt="..." /> &nbsp; <span>Michelle</span> </a>
                                    </li>
                                </ul>
                                <!-- /.bottom_data -->
                                <ul class="bottom_data pull-right hidden-xs-down">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <ul class="author-2">
                                    <li>
                                        <a href="#"><img class="" src="img/users/2.jpg" alt="..." /> &nbsp; <span>Alex</span> </a>
                                    </li>
                                </ul>
                                <!-- /.bottom_data -->
                                <ul class="bottom_data pull-right hidden-xs-down">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <ul class="author-2">
                                    <li>
                                        <a href="#"><img class="" src="img/users/3.jpg" alt="..." /> &nbsp; <span>David</span> </a>
                                    </li>
                                </ul>
                                <!-- /.bottom_data -->
                                <ul class="bottom_data pull-right hidden-xs-down">
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <ul class="author-2">
                                    <li>
                                        <a href="#"><img class="" src="img/users/4.jpg" alt="..." /> &nbsp; <span>Jonathan</span> </a>
                                    </li>
                                </ul>
                                <!-- /.bottom_data -->
                                <ul class="bottom_data pull-right hidden-xs-down">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <ul class="author-2">
                                    <li>
                                        <a href="#"><img class="" src="img/users/5.jpg" alt="..." /> &nbsp; <span>Kyle</span> </a>
                                    </li>
                                </ul>
                                <!-- /.bottom_data -->
                                <ul class="bottom_data pull-right hidden-xs-down">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <ul class="author-2">
                                    <li>
                                        <a href="#"><img class="" src="img/users/6.jpg" alt="..." /> &nbsp; <span>Victoria</span> </a>
                                    </li>
                                </ul>
                                <!-- /.bottom_data -->
                                <ul class="bottom_data pull-right hidden-xs-down">
